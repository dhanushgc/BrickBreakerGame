...
public class Board extends JPanel implements Runnable, Constants {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2410387485963917292L;
	//Items on-screen
	...
	public Board(int width, int height) {
		...
		if (playerName.toUpperCase().equals("LOL") || playerName.toUpperCase().equals("ROFL") || playerName.toUpperCase().equals("WINNER") || playerName.toUpperCase().equals("NUMBER ONE") || playerName.toUpperCase().equals("HEY") || playerName.toUpperCase().equals("YUKTHI") || playerName.toUpperCase().equals("DHANUSH")) {
			score += 1000;
